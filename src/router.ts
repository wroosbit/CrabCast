  ...
  public async handleActivate(data: any, respond: Respond): Promise<void> {
    ...
    if (occupancy.ours) {
      ...
      respond({
        ...
        // running. That is the same reason `recordReconciled` exists below:
        // both are this branch answering about the world it leaves behind
        // rather than about the disk it found.
